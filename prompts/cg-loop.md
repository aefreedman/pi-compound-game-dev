...
- Plastic: create `<current-branch>/loop-<YYYYMMDD>-<short-plan>` from current branch.
...
- Complete only after all five stages finish and all in-scope todos are handled.
