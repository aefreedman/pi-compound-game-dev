...
assert(artifactSearchText.includes("rootsMatch") && artifactSearchText.includes("defaultIndexFilename") && artifactSearchText.includes("activeIndexRoots") && artifactSearchText.includes("artifact-index-${label"), "Expected artifact indexes to isolate and dirty-track custom workspace roots.");
